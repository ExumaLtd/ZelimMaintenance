...
export default function AnnualComplete() {
  ...
  return (
    <div className="form-scope">
      <Head>
        <title>Annual Maintenance Complete | Zelim</title>
      </Head>
        ...
        <div className="page-wrapper">
          <div className="swift-checklist-container">
            ...
            <div className="complete-card">
              ...
              <h1 className="complete-title">Annual Maintenance Submitted</h1>
              
              <p className="complete-text">
                The annual maintenance record has been successfully uploaded to Airtable. 
