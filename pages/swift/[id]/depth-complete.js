...
export default function DepthComplete({ unit }) {
  return (
    <div className="form-scope">
      <Head>
        <title>Depth Maintenance Complete | SWIFT</title>
      </Head>
        ...
        <div className="page-wrapper">
          <div className="swift-checklist-container complete-page">
            ...
            <h1 className="checklist-hero-title">
              {unit?.serial_number}
              <span className="break-point" style={{ color: '#01FFF6' }}>30-Month depth maintenance complete</span>
            </h1>
            ...
            <div className="checklist-form-card" style={{ textAlign: 'center', padding: '40px' }}>
              ...
              <p className="completion-message" style={{ color: '#FFFFFF', fontSize: '18px', marginBottom: '32px', lineHeight: "26px" }}>
                The depth maintenance checklist has been successfully submitted and the system logs have been updated.
              </p>
