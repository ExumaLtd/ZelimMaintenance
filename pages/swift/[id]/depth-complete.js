...
export default function DepthComplete() {
  ...
  return (
    <div className="form-scope">
      <Head>
        <title>Depth Maintenance Complete | Zelim</title>
      </Head>
        ...
        <div className="page-wrapper">
          <div className="swift-checklist-container">
            ...
            <div className="complete-card">
              ...
              <h1 className="complete-title">Depth Maintenance Submitted</h1>
              
              <p className="complete-text">
                The depth maintenance record has been successfully uploaded to Airtable. 
